...
bot.action(/^test:(.+)$/, async (ctx) => {
    ...
    try {
        ...
        await ctx.reply(
            ...
            `❗️ Пожалуйста, дождитесь окончания генерации`
        );
        ...
        await Promise.race([
            (async () => {
                ...
                console.log("Вопросы сгенерированы, отправляем результат...");
                await ctx.reply("✅ AI модель завершила работу\n🎯 Этап 3/3: Форматирование результата");
